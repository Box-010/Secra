    ...
    <form action="install.php" method="post">
      <div class="card" id="publish">
        <div class="card-content">
          ...
          <div class="textfield-wrapper">
            <div class="textfield">
              <input type="text" id="db_host" name="db_host"
                     required <?php echo defined('DB_HOST') ? 'value="' . DB_HOST . '"' : 'value="localhost"'; ?> />
          ...
          <div class="textfield-wrapper">
            <div class="textfield">
              <input type="text" id="db_port" name="db_port"
                     required <?php echo defined('DB_PORT') ? 'value="' . DB_PORT . '"' : 'value="3306"'; ?> />
          ...
          <div class="textfield-wrapper">
            <div class="textfield">
              <input type="text" id="db_name" name="db_name"
                     required <?php echo defined('DB_NAME') ? 'value="' . DB_NAME . '"' : ''; ?> />
              <label for="db_name">数据库名</label>
            </div>
          </div>
          <div class="textfield-wrapper">
            <div class="textfield">
              <input type="text" id="db_root_user" name="db_root_user"
                     required <?php echo defined('DB_ROOT_USER') ? 'value="' . DB_ROOT_USER . '"' : ''; ?> />
              <label for="db_root_user">数据库超级用户</label>
            </div>
          </div>
          <div class="textfield-wrapper">
            <div class="textfield">
              <input type="password" id="db_root_pass" name="db_root_pass"
                     required <?php echo defined('DB_ROOT_PASS') ? 'value="' . DB_ROOT_PASS . '"' : ''; ?> />
              <label for="db_root_pass">数据库超级用户密码</label>
            </div>
          </div>
          <div class="textfield-wrapper">
            <div class="textfield">
              <input type="text" id="db_user" name="db_user"
                     required <?php echo defined('DB_USER') ? 'value="' . DB_USER . '"' : ''; ?> />
              <label for="db_user">数据库用户名</label>
            </div>
            <span class="helper-text">安装时会自动创建此用户并授予数据库权限。</span>
          </div>
          <div class="textfield-wrapper">
            <div class="textfield">
              <input type="password" id="db_pass" name="db_pass"
                     required <?php echo defined('DB_PASS') ? 'value="' . DB_PASS . '"' : ''; ?> />
          ...
          <div class="textfield-wrapper">
            <div class="textfield">
              <input type="text" id="admin_user" name="admin_user"
                     required <?php echo defined('ADMIN_USERNAME') ? 'value="' . ADMIN_USERNAME . '"' : ''; ?> />
          ...
          <div class="textfield-wrapper">
            <div class="textfield">
              <input type="password" id="admin_pass" name="admin_pass"
                     required <?php echo defined('ADMIN_PASSWORD') ? 'value="' . ADMIN_PASSWORD . '"' : ''; ?> />
          ...
          <div class="textfield-wrapper">
            <div class="textfield">
              <input type="email" id="admin_email" name="admin_email"
                     required <?php echo defined('ADMIN_EMAIL') ? 'value="' . ADMIN_EMAIL . '"' : ''; ?> />
          ...
          <div class="textfield-wrapper">
            <div class="textfield">
              <input type="text" id="public_root" name="public_root"
                     required <?php echo defined('PUBLIC_ROOT') ? 'value="' . PUBLIC_ROOT . '"' : '/'; ?> />
