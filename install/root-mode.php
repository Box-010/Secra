      ...
      <form action="install.php" method="post">
        <div class="card" id="publish">
          <div class="card-content">
            ...
            <div class="textfield-wrapper">
              <div class="textfield">
                <input type="text" id="db_root_user" name="db_root_user" required <?php echo defined('DB_ROOT_USER') ? 'value="' . DB_ROOT_USER . '"' : ''; ?> />
                <label for="db_root_user">数据库超级用户</label>
              </div>
            </div>
            <div class="textfield-wrapper">
              <div class="textfield">
                <input type="password" id="db_root_pass" name="db_root_pass" required <?php echo defined('DB_ROOT_PASS') ? 'value="' . DB_ROOT_PASS . '"' : ''; ?> />
